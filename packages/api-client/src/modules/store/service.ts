...
export class StoreService {
  static async findMany(input: StoreFindManyInput): Promise<Maybe<Fragment_Store_FieldsFragment>[]> {
  ...
  static async findOne(input: StoreFindOneInput): Promise<Fragment_Store_FieldsFragment> {
